...
local SkinsData = {
    ["Mechanical"] = {
        ...
        [9] = {
            --Border between micro buttons and leave button
            layer = "ARTWORK",
            height = 96,
            width = 26,
            point = "BOTTOMRIGHT",
