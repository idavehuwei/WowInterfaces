...
CALENDAR_SIGNEDUP_FOR_GUILDEVENT = "已登记";
CALENDAR_SIGNUP = "登记";
...
CONFIRM_REFUND_MAX_ARENA_POINTS = "你的竞技场点数已接近上限。出售这件物品将使你损失%d竞技场点数。确认要继续吗？";
CONFIRM_REFUND_MAX_HONOR = "你的荣誉点数已接近上限。出售这件物品将使你损失%d荣誉点数。确认要继续吗？";
...
INSTANCE_LEAVE = "离开副本";
INSTANCE_LOCK_TIMER = "你进入了一个已经保存进度的副本！你将在%3$s内被保存到%2$s难度的%1$s副本进度中！";
...
OPTION_TOOLTIP_PREVIEW_TALENT_CHANGES = "启用此项之后，你可以在真正花费天赋点数之前，在天赋界面中改变天赋配置。";
...
OPTION_TOOLTIP_USE_EQUIPMENT_MANAGER = "可以通过角色信息界面进行多种装备方案的管理。";
...
RAID_INSTANCE_EXPIRES_EXPIRED = "已延长";
...
REFRESH = "刷新";
REFRESH_RATE = "刷新";
REFUND_TIME_REMAINING = "在%s内将这件物品退还给商人可以获得全额退款";
RELICSLOT = "圣物";
REMOVE = "移除";
