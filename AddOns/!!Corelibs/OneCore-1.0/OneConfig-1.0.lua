...
local MAJOR, MINOR = "OneConfig-1.0", tonumber("40") or 9999
                        ...
                        item = {
                            ...
                            args = {
                                ...
                                questitem = {
                                    ...
                                    desc = L["Toggles if you want to color quest item's borders as well."],
                                    get = function(info)
                                        return self.db.profile.appearance.questitem
                                    end,
                                    set = function(info, value)
                                        self.db.profile.appearance.questitem = value
                                        self:UpdateFrame()
                                    end,
                                },
                            }
