...
local BasePanel = CreateBasePanel( "TidyPlatesNeon", "Tidy Plates: Neon", nil ) 
...
local function CreateInterfacePanel( Name, Title, Parent, VariableTarget )  
	...
	-------------------
	-- Health Bar
	--panel.ShowName = PanelHelpers:CreateCheckButton(Name.."_ShowName", Column1, "Show Name:")
	--panel.ShowName:SetPoint("LEFT")
	--panel.ShowName:SetPoint("TOP", panel.HealthText, "BOTTOM",0, -4)
	
	panel.CustomFont = PanelHelpers:CreateDropdownFrame(Name.."_FontDropdown", Column1, SharedMediaFontList, 1, "Nameplate Text:", true)
...
--]]
	...
	-- Loose Units
	panel.AggroLooseColor = PanelHelpers:CreateColorBox(Name.."_AggroSafeColor", Column1, "Loose Color", 0, .5, 1, 1)
	panel.AggroLooseColor:SetPoint("LEFT", 24)
	panel.AggroLooseColor:SetPoint("TOP", panel.AggroColorDesc, "BOTTOM", 0,-8)

	-- Tanked Units
	panel.AggroTankedColor = PanelHelpers:CreateColorBox(Name.."_AggroDangerColor", Column1, "Aggro/Tanked Color", 0, .5, 1, 1)
	...
	-- Loose Color
	panel.TugWidgetLooseColor = PanelHelpers:CreateColorBox(Name.."_TugWidgetLooseColor", Column2, "Loose Color", 0, .5, 1, 1)
	...
	-- Safe 
	panel.TugWidgetSafeColor = PanelHelpers:CreateColorBox(Name.."_TugWidgetSafeColor", Column2, "Other Tank Color", 0, .5, 1, 1)
...
-- Login
--TankPanel = CreateInterfacePanel( "TidyPlatesNeonTank", "Tidy Plates: Neon/Tank", nil, TidyPlatesNeonTankVariables ) 
TankPanel = CreateInterfacePanel( "TidyPlatesNeonTank", "Neon/Tank", "Tidy Plates: Neon", TidyPlatesNeonTankVariables ) 
...
BasePanel.TankModeButton:SetScript("OnClick", function() InterfaceOptionsFrame_OpenToCategory("Neon/Tank") end)
BasePanel.DPSModeButton:SetScript("OnClick", function() InterfaceOptionsFrame_OpenToCategory("Neon/DPS") end)
