...
L["Filter_Desc"] = "選擇你想要在世界地圖和小地圖上顯示的資源點類型,不選擇的類型將僅記錄在數據庫中."
L["Filters"] = "過濾"
L["Fishes"] = "魚群"
L["Fish filter"] = "魚群過濾"
L["Fishing"] = "釣魚"
...
L["Selected databases are shown on both the World Map and Minimap."] = "在世界地圖和小地圖上顯示已選用的數據庫."
L["Select Node"] = "選擇資源點"
L["Select None"] = "清空選擇"
