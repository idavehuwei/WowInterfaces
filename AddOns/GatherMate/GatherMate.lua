...
local defaults = {
    profile = {
        ...
        trackColors = {
            ["Herb Gathering"] = {Red = 0, Green = 1, Blue = 0, Alpha = 0.5},
            ["Fishing"]        = {Red = 1, Green = 1, Blue = 0, Alpha = 0.5},
            ["Mining"]         = {Red = 1, Green = 0, Blue = 0, Alpha = 0.5},
            ["Extract Gas"]    = {Red = 0, Green = 1, Blue = 1, Alpha = 0.5},
            ["Treasure"]       = {Red = 1, Green = 0, Blue = 1, Alpha = 0.5},
            ["*"]              = {Red = 1, Green = 0, Blue = 1, Alpha = 0.5},
        },
        trackDistance = 150,
        trackShow = "always",
        nodeRange = true,
