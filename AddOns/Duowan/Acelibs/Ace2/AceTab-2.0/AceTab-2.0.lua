...
local function hookFrame(Gframe)
	...
	if strfind(tostring(Gframe:GetName()), "^ChatFrame%d+EditBox") then
...
function AceTab:RegisterTabCompletion(descriptor, regex, wlfunc, usage, editframes)
	...
	if not editframes then
		editframes = {"ChatFrame1EditBox", "ChatFrame2EditBox", "ChatFrame3EditBox", "ChatFrame4EditBox", "ChatFrame5EditBox", "ChatFrame6EditBox", "ChatFrame7EditBox", "ChatFrame8EditBox", "ChatFrame9EditBox", "ChatFrame10EditBox", }
...
function AceTab:OnTabPressed(this)
	...
	if strfind(tostring(this:GetName()), "^ChatFrame%d+EditBox") then
