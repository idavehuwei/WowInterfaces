...
if (dwIsConfigurableAddOn("GearScoreLite") or dwIsConfigurableAddOn("RatingSummary") or dwIsConfigurableAddOn("Fizzle")  or dwIsConfigurableAddOn("RatingBuster")) then	
	dwRegisterMod(
		"ChracterInfo",
