...
if (GetLocale() == "zhCN") then
	...
	FIGHTING_OPTION3 = "开启伤害输出";
	FIGHTING_OPTION4 = "开启法术预警";
...
elseif (GetLocale() == "zhTW") then
	...
	FIGHTING_OPTION3 = "開啟傷害輸出";
	FIGHTING_OPTION4 = "開啟法術預警";
		...
		dwRegisterCheckButton(
			...
			function (arg)
				if(arg==1)then
					...
					DuowanAddon_DCTD_PERCONFIG["DCTD_ENABLE"] = 1;
				else
					if (dwIsAddOnLoaded("dct_damage") and DuowanAddon_DCTD_PERCONFIG) then
						DuowanAddon_DCTD_PERCONFIG["DCTD_ENABLE"] = 0;
					end
				end
			end,
			1
