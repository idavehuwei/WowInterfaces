	--Chinese Big5 Local : CWDG Translation Team papabear612
	--$Rev: 738 $
	--$Date: 2007-06-20 07:32:56 +0800 (星期三, 20 六月 2007) $
if (GetLocale() == 	"zhTW") then
	ACP:UpdateLocale( {
		...
		["Undefined"] = "未分類",
		["Notes:"] =  "注意:",
		["Don't load AddOns of Duowan here."] = "不要這裏加載多玩的插件.",
		["Blizzard"] = "暴雪",
		["Show Duowan AddOns"] = "顯示多玩魔盒的插件",
	} )
end
