...
L["ChatFrame"]="聊天快捷欄"
L["IconFrame"]="聊天表情欄"
L["DWChat provides you convient tools like copy text, name highlight and timestamps"]="大腳聊天增強為妳提供復制聊天文字，高亮姓名以及聊天時間顯示等各種功能。"
L["Enable DWChat"]="使用大腳聊天增強"
...
if GetLocale()=="zhTW" then
	BINDING_HEADER_DWCTITLE="大腳聊天增強"
