...
if (GetLocale() == "zhCN") then
	...
	Show_Sell_Value_TOOLTIP="显示物品出售价格或可堆叠物品的单价"
	
	__L["Show Total Value"]			= "物品总价";
	Show_Total_Value_TOOLTIP="显示可堆叠物品出售总价"
	...
	__L["Show Item Qulity"]			= "物品质量";
	Show_Item_Qulity_TOOLTIP="用文字方式说明物品质量"
...
elseif (GetLocale() == "zhTW") then
	...
	Show_Sell_Value_TOOLTIP="顯示物品出售價格或可堆疊物品的單價"
	
	__L["Show Total Value"]			= "物品總價";
	Show_Total_Value_TOOLTIP="顯示可堆疊物品出售總價"
	...
	__L["Show Item Qulity"]			= "物品質量";
	Show_Item_Qulity_TOOLTIP="用文字方式說明物品質量"
