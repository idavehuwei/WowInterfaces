...
if (GetLocale() == "zhCN") then
	...
	BIGFOOT_TOOLTIP_OPTION = {
		...
		[7] = { "BigFootTooltipReduce", "物理免伤:", {"隐藏", "显示"}, nil, "显示" },
		[8] = { "BigFootTooltipToT", "目标的目标:", {"隐藏", "显示"}, nil, "显示" },
		[9] = { "BigFootTooltipPvP", "PvP:", {"显示", "隐藏"}, nil, "隐藏" },
	};
elseif (GetLocale() == "zhTW") then
	BIGFOOT_TOOLTIP = {"鼠標提示", "shubiaotishi"};
	ENABLE_BIGFOOT_TOOLTIP = "啓用大腳鼠標提示";
	BIGFOOT_TOOLTIP_OPTION = {
		...
		[7] = { "BigFootTooltipReduce", "物理免傷:", {"隱藏", "顯示"}, nil, "顯示" },
		[8] = { "BigFootTooltipToT", "目標的目標:", {"隱藏", "顯示"}, nil, "顯示" },
		[9] = { "BigFootTooltipPvP", "PvP:", {"顯示", "隱藏"}, nil, "隱藏" },
	};
else
	...
	BIGFOOT_TOOLTIP_OPTION = {
		...
		[7] = { "BigFootTooltipReduce", "Reduce:", {"Hide", "Show"}, nil, "Show" },
		[8] = { "BigFootTooltipToT", "ToT:", { "Hide", "Show"}, nil, "Show" },
		[9] = { "BigFootTooltipPvP", "PvP:", {"Show", "Hide"}, nil, "Hide" },
	};
end
