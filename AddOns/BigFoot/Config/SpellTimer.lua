...
if (GetLocale() == "zhCN") then
    SPELL_TIMER = { "法术计时器", "fashujishiqi" };
    SPELL_TIMER_ENABLE = "启用法术计时器";
elseif (GetLocale() == "zhTW") then
    SPELL_TIMER = { "法術計時器", "fashujishiqi" };
    SPELL_TIMER_ENABLE = "啓用法術計時器";
else
