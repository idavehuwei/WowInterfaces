...
L["TITAN_PANEL_MENU_DISPLAY_BOTH"] = "同时显示2个泰坦条";
...
L["TITAN_UISCALE_MENU_TEXT"] = "泰坦面板设置";
L["TITAN_UISCALE_CONTROL_TITLE_UI"] = "界面缩放";
L["TITAN_UISCALE_CONTROL_TITLE_PANEL"] = "泰坦面板缩放";
...
L["TITAN_UISCALE_MENU_DESC"] = "设置泰坦面板和插件的外观.";
L["TITAN_UISCALE_SLIDER_DESC"] = "控制你所有插件的缩放.";
L["TITAN_UISCALE_PANEL_SLIDER_DESC"] = "设置泰坦面板的按钮和图标缩放.";
L["TITAN_UISCALE_BUTTON_SLIDER_DESC"] = "调整左侧模块的间距.";
L["TITAN_UISCALE_TOOLTIP_SLIDER_DESC"] = "调整泰坦的扩展模块的提示说明缩放.";
L["TITAN_UISCALE_DISABLE_TOOLTIP_DESC"] = "禁用泰坦的提示文字缩放.";
L["TITAN_SKINS_MAIN_DESC"] = "管理泰坦信息条的皮肤.";
L["TITAN_SKINS_LIST_TITLE"] = "皮肤列表";
L["TITAN_SKINS_SET_DESC"] = "给泰坦信息条选择一个皮肤.";
...
L["TITAN_SKINS_NAME_EXAMPLE"] = "例如: 我的泰坦皮肤";
...
L["TITAN_PANEL_MENU_LSM_FONTS_DESC"] = "选择泰坦条上各个模块的字体样式.";
...
L["TITAN_CLOCK_TOOLTIP_HINT3"] = "Shift+左键单击 打开/关闭计时器.";
