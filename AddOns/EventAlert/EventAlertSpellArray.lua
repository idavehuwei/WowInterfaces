...
if EA_Items[EA_CLASS_FUNKY] == nil then EA_Items[EA_CLASS_FUNKY] = {} end;
...
if EA_Items[EA_CLASS_PRIEST] == nil then EA_Items[EA_CLASS_PRIEST] = {} end;
    ...
    if EA_Items[EA_CLASS_FUNKY][63731] == nil then EA_Items[EA_CLASS_FUNKY][63731] = true end;
    if EA_Items[EA_CLASS_FUNKY][63734] == nil then EA_Items[EA_CLASS_FUNKY][63734] = true end;
    if EA_Items[EA_CLASS_FUNKY][63735] == nil then EA_Items[EA_CLASS_FUNKY][63735] = true end;
...
if EA_Items[EA_CLASS_OTHER] == nil then EA_Items[EA_CLASS_OTHER] = {} end;
    ...
    if EA_Items[EA_CLASS_OTHER][33370] == nil then EA_Items[EA_CLASS_OTHER][33370] = true end;
...
function EventAlert_RemoveOldSpells()
    if EA_Items[EA_CLASS_PALADIN][27179] == true then EA_Items[EA_CLASS_PALADIN][27179] = nil end;
    if EA_Items[EA_CLASS_PALADIN][27151] == true then EA_Items[EA_CLASS_PALADIN][27151] = nil end;
    if EA_Items[EA_CLASS_WARLOCK][47274] == true then EA_Items[EA_CLASS_WARLOCK][47274] = nil end;
    if EA_Items[EA_CLASS_PRIEST][34754] == true then EA_Items[EA_CLASS_PRIEST][34754] = nil end;
    if EA_Items[EA_CLASS_DK][50466] == true then EA_Items[EA_CLASS_DK][50466] = nil end;
