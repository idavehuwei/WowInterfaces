...
function EN_TargetTargetTarget_OnLoad(self)
	...
	UnitFrame_Initialize(self, "TargetTargetTarget", 
		dwGetglobal(pretot.."Name"), dwGetglobal(pretot.."Portrait"), 
		dwGetglobal(pretot.."HealthBar"), dwGetglobal(pretot.."HealthBarText"), 
		dwGetglobal(pretot.."ManaBar"), dwGetglobal(pretot.."ManaBarText")
	);
	SetTextStatusBarTextZeroText(dwGetglobal(pretot.."HealthBar"), DEAD);    
