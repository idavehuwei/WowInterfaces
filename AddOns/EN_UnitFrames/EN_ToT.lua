...
function ETT_TargetTargetFrame_OnLoad()
...
function ETT_TargetTargetTargetFrame_OnLoad()
    local showmenu = function()
...
;
function ETT_TargetTargetFrame_DragStart(button)
    if EUF_CurrentOptions["MOVINGTARGETTARGETFRAME"] == 1 then
...
function ETT_TargetTargetFrame_DragStop(button)
