...
--	CursorHasItem = Accountant_CursorHasItem;
	...
	dwAsynCall("Blizzard_AuctionUI", "Accountant_CreateActionButton");	
end

function Accountant_CreateActionButton()
	local button2 =  CreateFrame("Button", "AccMerchantToggleButton", AuctionFrameBrowse, "UIPanelButtonTemplate");
	button2:SetWidth(100);
	button2:SetHeight(25);
	button2:SetText(ACCLOC_TITLE);
	button2:SetFrameLevel(BrowsePrevPageButton:GetFrameLevel()+1);
	button2:SetPoint("RIGHT", BrowsePrevPageButton, "LEFT", -10, 5);
