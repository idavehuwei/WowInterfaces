...
function mod:OnCombatStart(delay)
    ...
    sndWOP:Schedule(70-delay, "Interface\\AddOns\\DBM-Core\\extrasounds\\burrowsoon.mp3")
    ...
    if mod:IsDifficulty("heroic10") or mod:IsDifficulty("heroic25") then
        ...
        if self.Options.PlaySoundOnShadowStrike then
            sndWOP:Schedule(25.5-delay, "Interface\\AddOns\\DBM-Core\\extrasounds\\sstrikesoon.mp3")
            sndWOP:Schedule(27.5-delay, "Interface\\AddOns\\DBM-Core\\extrasounds\\countthree.mp3")
            sndWOP:Schedule(28.5-delay, "Interface\\AddOns\\DBM-Core\\extrasounds\\counttwo.mp3")
            sndWOP:Schedule(29.5-delay, "Interface\\AddOns\\DBM-Core\\extrasounds\\countone.mp3")
        end
...
function mod:ShadowStrike()
    if self:IsInCombat() then
        ...
        if self.Options.PlaySoundOnShadowStrike then
            sndWOP:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\sstrikesoon.mp3")
            ...
            sndWOP:Schedule(25.5, "Interface\\AddOns\\DBM-Core\\extrasounds\\sstrikesoon.mp3")
...
function mod:SPELL_CAST_START(args)
    if args:IsSpellID(66118, 67630, 68646, 68647) then -- Swarm (start p3)
        ...
        sndWOP:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\burrowsoon.mp3")
...
function mod:CHAT_MSG_RAID_BOSS_EMOTE(msg)
    ...
    elseif msg and msg:find(L.Emerge) or msg:find(L.enUS.Emerge) then
        ...
        sndWOP:Schedule(65, "Interface\\AddOns\\DBM-Core\\extrasounds\\burrowsoon.mp3")
