...
Change Log:
	...
	v2.0.5
		...
		- Added Lady Deathwhisper's Vengeful Blast
	...
	v2.9
		- Fixed Lady Deathwhisper's Vengeful Blast
	v2.9.1
		- Added Prince Valanar's Empowered Shock Vortex (Friendly Fire)
	v3.0
		- Added Ulduar's Bomb Bot 
		- Added Mimiron's Frost Bomb Explosion
	v3.1
		- Added Sindragosa's Frost Bomb (Heroic + 10 Normal)
		- Added Ormorok the Tree Shaper's Crystal Spike
		- Added Anub'arak's Impale
		- Added Anub'arak's Pound
	v3.2
		- Added Loken's Lightning Nova
		- Added Onyxia's Cleave
		- Added Onyxia's Tail Sweep
	v3.2.1
		- Added Deathbound Ward's Saber Lash
		- Added Sapphiron's Tail Sweep
		- Added Grobbulus's Slime Spray
		- Added Keristrasza's Tail Sweep
		- Added Keristrasza's Crystalfire Breath
		- Added Ingvar the Plunderer's Smash
	v3.2.5
		- Added Sartharion's Flame Breath
		- Added Sartharion's Cleave
		- Added Sartharion's Tail Lash
		- Added Drakes's Shadow Breath	
]]--
