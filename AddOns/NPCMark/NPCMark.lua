...
function BFM_ToggleEnable(switch) 
	if ( switch == 1 ) then 
		if (not NPCMark_0ff1475236b21cc42bc579ef6b84a020) then
			WorldMapFrame:HookScript("OnUpdate", NPCMark_359af385f8090e4c5839f533807d0e06);
			NPCMark_0ff1475236b21cc42bc579ef6b84a020 = true;
...
function NPCMark_ae42389ca37ac306b6bc3f5dfc08ff0d()
	if (not NPCMark_3657b630f9b53060aa76a1ee4510bd5f) then 
		MapPlusDDList:Hide() 
...
function NPCMark_359af385f8090e4c5839f533807d0e06(self) 
	hideNodes() 
	if not NPCMark_3657b630f9b53060aa76a1ee4510bd5f then 
		return 
	end
...
function MapMarkToggle_OnClick(self)
...
function MapMarkToggle_OnLoad(self)
	self:SetFrameLevel(self:GetFrameLevel() + 4);
end

function MapMarkToggle_OnShow(self)
	if (MapMarkHide) then
		self:SetChecked(0);
	else
		self:SetChecked(1);
