...
--{{{ GridCore
	...
	["Automatically swap profiles when switching talent specs."] = "Automatically swap profiles when switching talent specs.",
...
--}}}
	...
	["Adjust the font outline."] = "Adjust the font outline.",
	["Thin"] = "Thin",
	["Thick"] = "Thick",
	["By Class 10"] = "By Class 10",
	["By Class 25"] = "By Class 25",	
	["Click to open the options in a GUI window."] = "Click to open the options in a GUI window.",
	["Right-Click to open the options in a drop-down menu."] = "Right-Click to open the options in a drop-down menu.",
	["Select the profile to swap with the current profile when switching talent specs."] = "Select the profile to swap with the current profile when switching talent specs.",
}
