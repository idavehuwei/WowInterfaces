...
Recount.Version = tonumber(string.sub("$Revision: 1081 $", 12, -3))
...
--				["GUARDIAN"] = { r = 0.61, g = 0.09, b = 0.09 },
		...
		ConfirmDeleteInstance=false, -- Elsia: Get annoying popup box?
...
function Recount:AddGreaterElemental(opts)
	...
	--local mobid = tonumber(nameGUID:sub(7,10),16)
