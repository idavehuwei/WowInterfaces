...
Recount.Version = tonumber(string.sub("$Revision: 1060 $", 12, -3))
    ...
    args = {
        ...
        [L["gui"]] = {
            ...
            func = function()
                ...
                AceConfigDialog:SetDefaultSize(L["Recount"], 500, 550)
                AceConfigDialog:Open(L["Recount"]) end
        },
        [L["sync"]] = {
            order = 21,
            name  = L["Sync"],
...
function Recount:AddCombatant(name,owner,nameGUID,nameFlags,ownerGUID)
    ...
    if owner then
        combatant.Name=string_match(name,"(.*) <"..owner..">")
...
function Recount:OnInitialize()
    ...
    Recount.db = acedb:New("DuowanAddon_RecountDB", Default_Profile)
 -- Recount.db2 = acedb:New("DuowanAddon_RecountPerCharDB", DefaultConfig)
    DuowanAddon_RecountPerCharDB = DuowanAddon_RecountPerCharDB or {}
    Recount.db2 = DuowanAddon_RecountPerCharDB
    ...
    LibStub("AceConfig-3.0"):RegisterOptionsTable(L["Recount"], Recount.consoleOptions2, L["Recount"])
    ...
    AceConfigDialog:AddToBlizOptions("Recount Blizz",  L["Recount"])
    AceConfigDialog:AddToBlizOptions("Recount Profile", L["Profile"], L["Recount"])
    AceConfigDialog:AddToBlizOptions("Recount Report", L["Report"], L["Recount"])
    AceConfigDialog:AddToBlizOptions("Recount Realtime", L["Realtime"], L["Recount"])
