...
L["Send bugs"] = "发送错误"
L["Sends your current session bugs to another BugSack user."] = "发送你当前进程错误给其他装有 BugSack 的玩家。"
L["<player name>"] = "<玩家姓名>"
L["Menu"] = "目录"
L["Menu options."] = "目录选项"
...
L["Print the full error message to the chat frame instead of just a warning."] = "显示详细的错误信息到聊天栏中而非是一条警告。"
L["Mute"] = "静音"
...
L["Whether to throttle for a default of 60 seconds when BugGrabber catches more than 20 errors per second."] = "当 BugGrabber 捕获错误信息20次/秒，是否以默认值60秒频率过滤。"
...
L["%d sec."] = "%d秒。"
L["|cffeda55fBugGrabber|r is paused due to an excessive amount of errors being generated. It will resume normal operations in |cffff0000%d|r seconds. |cffeda55fDouble-Click|r to resume now."] = "由于错误数量过量产生，所以 |cffeda55fBugGrabber|r 已暂停工作。它将在|cffff0000%d|r后重新开始正常运行。|cffeda55f双击|r直接重新开始。"
...
L["%d errors have been recorded."] = "已记录%d个错误。"
L["You've received %d errors from %s, you can show them with /bugsack show received."] = "你已从%d接收到%d个错误，你可以通过输入 /bugsack 来显示。"
L["%d errors has been sent to %s. He must have BugSack to be able to read them."] = "%d个错误已经发送给%s。他必须安装 BugSack 插件才能查看错误信息。"
...
-- FuBar plugin
L["|cffeda55fClick|r to open BugSack with the last error. |cffeda55fShift-Click|r to reload the user interface. |cffeda55fAlt-Click|r to clear the sack."] = "|cffeda55f点击|r打开 BugSack 及最后一错误信息。|cffeda55fShift-点击|r重新加载用户界面。|cffeda55fAlt-点击|r清除储存错误信息。"
