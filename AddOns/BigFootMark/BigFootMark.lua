...
MAP_MARK_TEXTURE = {
	[MAP_MARK_PROF_MAGE] = "Interface\\AddOns\\BigFootMark\\icon\\26", 
	[MAP_MARK_PROF_PRIEST] = "Interface\\AddOns\\BigFootMark\\icon\\31",
	[MAP_MARK_PROF_WARLOCK] = "Interface\\AddOns\\BigFootMark\\icon\\32",
	[MAP_MARK_PROF_ROGUE] = "Interface\\AddOns\\BigFootMark\\icon\\27", 
	[MAP_MARK_PROF_DRUID] = "Interface\\AddOns\\BigFootMark\\icon\\28",
	[MAP_MARK_PROF_HUNTER] = "Interface\\AddOns\\BigFootMark\\icon\\29", 
	[MAP_MARK_PROF_SHAMAN] = "Interface\\AddOns\\BigFootMark\\icon\\30",
	[MAP_MARK_PROF_WARRIOR] = "Interface\\AddOns\\BigFootMark\\icon\\25", 
	[MAP_MARK_PROF_PALADIN] = "Interface\\AddOns\\BigFootMark\\icon\\33",
	[MAP_MARK_PROF_DEATHKNIGHT] = "Interface\\AddOns\\BigFootMark\\icon\\34", 
	[MAP_MARK_SKILL_ALCHE] = "Interface\\AddOns\\BigFootMark\\icon\\2",
	[MAP_MARK_PROF_BLACKSMITH] = "Interface\\AddOns\\BigFootMark\\icon\\17", 
	[MAP_MARK_PROF_ENCHANTING] = "Interface\\AddOns\\BigFootMark\\icon\\19", 
	[MAP_MARK_PROF_ENGINEERING] = "Interface\\AddOns\\BigFootMark\\icon\\18", 
	[MAP_MARK_PROF_HERBALISM] = "Interface\\AddOns\\BigFootMark\\icon\\21",
	[MAP_MARK_PROF_INSCRIPTION] = "Interface\\AddOns\\BigFootMark\\icon\\9", 
	[MAP_MARK_PROF_JEWEL] = "Interface\\AddOns\\BigFootMark\\icon\\12",
	[MAP_MARK_PROF_LEATHERWORKING]= "Interface\\AddOns\\BigFootMark\\icon\\22", 
	[MAP_MARK_PROF_MINING] = "Interface\\AddOns\\BigFootMark\\icon\\23", 
	[MAP_MARK_PROF_SKINNING] = "Interface\\AddOns\\BigFootMark\\icon\\13", 
	[MAP_MARK_PROF_TAILORING] = "Interface\\AddOns\\BigFootMark\\icon\\24", 
	[MAP_MARK_PROF_COOKING] = "Interface\\AddOns\\BigFootMark\\icon\\11", 
	[MAP_MARK_PROF_FIRSTAID] = "Interface\\AddOns\\BigFootMark\\icon\\1", 
	[MAP_MARK_PROF_FISHING] = "Interface\\AddOns\\BigFootMark\\icon\\20", 
	[MAP_MARK_PROF_RIDING] = "Interface\\AddOns\\BigFootMark\\icon\\16", 
	[MAP_MARK_WEAPON] = "Interface\\AddOns\\BigFootMark\\icon\\5", 
	[MAP_MARK_INN] = "Interface\\AddOns\\BigFootMark\\icon\\35", 
	[MAP_MARK_GLADIUS] = "Interface\\AddOns\\BigFootMark\\icon\\6", 
	[MAP_MARK_FLY] = "Interface\\AddOns\\BigFootMark\\icon\\3", 
	[MAP_MARK_PORTAL] = "Interface\\AddOns\\BigFootMark\\icon\\15",
	[MAP_MARK_AUCTION] = "Interface\\AddOns\\BigFootMark\\icon\\7", 
	[MAP_MARK_BANK] = "Interface\\AddOns\\BigFootMark\\icon\\14",
	[MAP_MARK_BARBER] = "Interface\\AddOns\\BigFootMark\\icon\\8", 
	[MAP_MARK_MATERIAL] = "Interface\\AddOns\\BigFootMark\\icon\\10",
	[MAP_MARK_STABLE] = "Interface\\AddOns\\BigFootMark\\icon\\4", 
}
...
BigFootMarkMappingDB=BigFootMarkMappingDB or {
...
local function GetMappedType(_type) 
	if BigFootMarkMappingDB[_type] then 
		return BigFootMarkMappingDB[_type] 
	end
	for _,val in pairs(MAP_MARK_MAPPING_TABLE) do 
		if string.find(_type,val) then
			BigFootMarkMappingDB[_type] =val 
			return val 
		end 
	end
	return "" 
...
local function InitConfig()
	...
	-- 專業訓練師
	for _i = 1, GetNumSkillLines() do 
		skillName = GetSkillLineInfo(_i) 
		local mapping = MAP_MARK_MAPPING[skillName]
		if mapping then 
			BigFootMarkDB[mapping] = true 
		end
	end 
	...
	if (level == 1) then
		for key, subarray in pairs(MapMarkDDTable) do 
			...
			if subarray.func then
				info.hasArrow = false; 
				info.func = function() 
					BigFootMarkDB[key] = not BigFootMarkDB[key] 
				end
...
local function isSelected(type) 
	if BigFootMarkDB[GetMappedType(type)] then
		return true
	end 
