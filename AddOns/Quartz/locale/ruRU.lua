...
L["Above"] = "Выше"
L["Adjust the Border Style for non-interruptible Cast Bars"] = "Настроить стиль рамки для полос непрерываемых заклинаний" -- Needs review
...
L["Change the color of non-interruptible Cast Bars"] = "Изменить цвет полосы непрерываемых заклинаний" -- Needs review
...
L["Show the Shield Icon on non-interruptible Cast Bars"] = "Показывать иконку щита на полосах непрерываемых заклинаний" -- Needs review
