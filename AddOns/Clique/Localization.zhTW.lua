...
if GetLocale() == "zhTW" then
	...
	L["Set"] = "設置"
	L["New"] = "新建"	
	L["Clique Custom Editor"] = "Clique自定義編輯器"
	L["Set Click Binding"] = "設置點擊綁定"
	L["Click here to set icon"] = "點擊選擇圖示"
	L["Spell Name:"] = "法術名:"
	L["Macro Text:"] = "宏內容:"
	L["Save"] = "保存"
	L["Select an icon"] = "選擇一個圖示"
	L["Action Button %d%s"] = "動作鍵 %d%s"
	L["Action Bar: %s"] = "動作條: %s"
	L["Pet Action %d%s"] = "寵物重做條 %d%s"
	L["Show Menu"] = "顯示菜單"
	L["Cancel Pending Spell"] = "Cancel Pending Spell"
	L["Target Unit: %s"] = "選定目標: %s"
	L["Set Focus Unit: %s"] = "設置焦點: %s"
	L["Item: %s"] = "物品: %s"
	L["Macro: %s"] = "宏: %s"
	L["Clique Frame Editor"] = "Clique框架編輯器"	
	L["Change profile when switching talent specs"] = "切換天賦時改變配置檔"
