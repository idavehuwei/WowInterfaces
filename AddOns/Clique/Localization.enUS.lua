...
if GetLocale() then
	...
	L["Clique configuration"] = "Clique configuration"
	L["Profile Name"] = "Profile Name"
	L["Select a click-set to edit"] = "Select a click-set to edit"
	...
	L["Set"] = "Set"
	L["New"] = "New"
	L["Clique Custom Editor"] = "Clique Custom Editor"
	L["Set Click Binding"] = "Set Click Binding"
	L["Click here to set icon"] = "Click here to set icon"
	L["Spell Name:"] = "Spell Name:"
	L["Macro Text:"] = "Macro Text:"
	L["Save"] = "Save"
	L["Select an icon"] = "Select an icon"
	L["Action Button %d%s"] = "Action Button %d%s"
	L["Action Bar: %s"] = "Action Bar: %s"
	L["Pet Action %d%s"] = "Pet Action %d%s"
	L["Show Menu"] = "Show Menu"
	L["Cancel Pending Spell"] = "Cancel Pending Spell"
	L["Target Unit: %s"] = "Target Unit: %s"
	L["Set Focus Unit: %s"] = "Set Focus Unit: %s"
	L["Assist Unit: %s"] = "Assist Unit: %s"
	L["Item: %d,%d"] = "Item: %d,%d"
	L["Item: %s"] = "Item: %s"
	L["Macro: %s"] = "Macro: %s"
	L["Clique Frame Editor"] = "Clique Frame Editor"
	L["Set Click Binding"] = "Set Click Binding"
	L["Change profile when switching talent specs"] = "Change profile when switching talent specs"
