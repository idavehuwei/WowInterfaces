            ...
            args = {
                general = {
                    ...
                    args = {
                        ...
                        enabletimestampsecond = {
                            order = 10,
                            type = "toggle",
                            name = L["Enable second"],
                            disabled = function() return not BFC.db.profile.enabletimestamp end,
                            width = "full",
                        },
                        classheader = {
                            order = 12,
                        ...
                        enableclasscolor = {
                            ...
                            get = function() return BFC.db.profile.enableclasscolor end
                        },
                        channelheader = {
                            order = 14,
                            type = "header",
...
function BFC:ShowOptions()
    LibStub("AceConfigDialog-3.0"):Open("BigFootChat");
end

function BFC:SetupOptions()
    InterfaceOptionsFrame:SetFrameStrata("DIALOG")
    self.optionsFrames = {}
    LibStub("AceConfigRegistry-3.0"):RegisterOptionsTable("BigFootChat", getOptions)
