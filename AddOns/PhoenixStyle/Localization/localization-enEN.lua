...
psautomarnewinfo			= "|cff00ff00NEW!|r Now you can set more than one nick for each mark (comma-separated), if first player die or gone offline - mark will be updated on the next player in the list."
