...
-- /rb sum ignore gem
L["Ignore gems"] = "Игнорировать камни"
L["Ignore gems on items when calculating the stat summary"] = "Игнорировать камни при расчете итога"
-- /rb sum diffstyle
