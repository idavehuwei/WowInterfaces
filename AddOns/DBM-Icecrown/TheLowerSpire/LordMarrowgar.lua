...
function mod:OnCombatStart(delay)
    ...
    sndWOP:Schedule(40, "Interface\\AddOns\\DBM-Core\\extrasounds\\wwsoon.mp3")
...
function mod:SPELL_AURA_APPLIED(args)
    if args:IsSpellID(69076) then -- Bone Storm (Whirlwind)
        ...
        sndWOP:Schedule(85, "Interface\\AddOns\\DBM-Core\\extrasounds\\wwsoon.mp3")
...
function mod:SPELL_CAST_START(args)
    if args:IsSpellID(69057, 70826, 72088, 72089) then -- Bone Spike Graveyard
        warnBoneSpike:Show()
        sndWOP:Schedule(2, "Interface\\AddOns\\DBM-Core\\extrasounds\\killbone.mp3")
