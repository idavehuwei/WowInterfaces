...
function mod:OnCombatStart(delay)
    ...
    sndWOP:Schedule(35, "Interface\\AddOns\\DBM-Core\\extrasounds\\mobsoon.mp3")
    ...
    function mod:SPELL_SUMMON(args)
        if args:IsSpellID(72172, 72173) or args:IsSpellID(72356, 72357, 72358) then -- Summon Blood Beasts
            if time() - lastBeast > 5 then
                warnAdds:Show()
                sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\killbmob.mp3")
                sndWOP:Schedule(35, "Interface\\AddOns\\DBM-Core\\extrasounds\\mobsoon.mp3")
...
function mod:SPELL_AURA_APPLIED(args)
    if args:IsSpellID(72293) then -- Mark of the Fallen Champion
        ...
        sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\badmark.mp3")
