...
local threatfont = "Fonts\\ZYKai_T.TTF"
---------------
-- General Functions
---------------
    ...
    local function UpdateRoster()
        ...
        if UnitInRaid("player") then
            ...
            for index = 1, size do
                ...
                else RaidTankList[UnitName(raidid)] = nil
                end
            end
...
do
    ...
    local function UpdateThreatWheelWidget(frame, unit)
        ...
        elseif (GetTime() > frame.FadeTime) then frame:Hide()
        end
    end
        ...
        if unitid and unit.guid then
            ...
            if threat and threat > 0 then
                ...
                if topholder then
                    ...
                    else frame.TargetText:SetTextColor(1, 1, 1, 1)
                    end
                else frame.TargetText:SetText("")
                end
                -- Set Size
    ...
    local function UpdateTankedWidget(frame, unit)
        ...
        if unitid and unit.guid then
            ...
            if UnitExists(tot) then
                ...
                else frame.tank:Hide(); frame.squishy:Show()
                end
