...
L["Absorb details"] = "Details der Schadenabsorption" -- Needs review
...
L["Damage"] = "Schaden"
L["Damaged mobs"] = "Geschädigte Gegner" -- Needs review
...
L["Skada report on %s for %s, %s to %s:"] = "Skada: Bericht für %s gegen %s, %s bis %s:" -- Needs review
