...
function DCT_Opani_FrameBoxRefresh()
	...
	for i = 1,DCT_Ani_MaxFrame do
		obj = dwGetglobal("DCTAniOptionFrameBox"..i)
		obj:SetAlpha(0.7)
		if tp[i].active then
			obj:SetPoint("CENTER", "UIParent", "CENTER", DCT_Get("DCT_FRAME_CONFIG")[i].x, DCT_Get("DCT_FRAME_CONFIG")[i].y)
			dwGetglobal("DCTAniOptionFrameBox"..i.."_Title2"):SetText(DCT_Opani_AniTypeConfig[tp[i].aniType])
			obj:Show()
...
function DCT_Opani_FrameBoxHide()
	local i
	for i = 1,DCT_Ani_MaxFrame do
		dwGetglobal("DCTAniOptionFrameBox"..i):Hide()
	end
end
...
function DCT_Opani_OnShow()
	...
	if DCT_AniModeParamsSliders[DCT_Get("DCT_FRAME_CONFIG")[DCT_Opani_CurFrameID].aniType].Ddc then
		...
		local i
		for i = 1,c do
			dwGetglobal("DCTAniOptionparam"..i.."DDC"):Show()
			dwGetglobal("DCTAniOptionparam"..i.."DDC"):SetPoint("TOPLEFT", "DCTAniOptionAniTypeDDC", "TOPLEFT", 0, startY)			
			startY = startY - 40
		end
	end
	
	for i = 1,DCT_Ani_MaxFrame do
		dwGetglobal("DCTAniOptionFrameBox"..i.."_Title1"):SetText(DCT_TEXT_OPANI_FRAME.." "..i)
	end
...
function DCT_Opani_FrameDDC_OnShow()
	UIDropDownMenu_Initialize(this, DCT_Opani_FrameDDC_Initialize)
	UIDropDownMenu_SetSelectedID(this, DCT_Opani_CurFrameID)
	UIDropDownMenu_SetWidth(this,120)
	dwGetglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPANI_FRAMEDDC)
end
function DCT_Opani_FrameDDC_OnClick()
...
function DCT_Opani_FontEnDDC_OnShow()
	UIDropDownMenu_Initialize(this, DCT_Opani_FontEnDDC_Initialize)
	UIDropDownMenu_SetSelectedID(this, DCT_Get("DCT_FRAME_CONFIG")[DCT_Opani_CurFrameID].fEn)
	UIDropDownMenu_SetWidth(this,180)
	dwGetglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPEX_FONTENDDC)
end
function DCT_Opani_FontEnDDC_OnClick()
	local thisID = this:GetID()
...
function DCT_Opani_FontChDDC_OnShow()
	UIDropDownMenu_Initialize(this, DCT_Opani_FontChDDC_Initialize)
	UIDropDownMenu_SetSelectedID(this, DCT_Get("DCT_FRAME_CONFIG")[DCT_Opani_CurFrameID].fCh)
	UIDropDownMenu_SetWidth(this,180)
	dwGetglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPEX_FONTCHDDC)
end
function DCT_Opani_FontChDDC_OnClick()
	local thisID = this:GetID()
...
function DCT_Opani_FontEffDDC_OnShow()
	UIDropDownMenu_Initialize(this, DCT_Opani_FontEffDDC_Initialize)
	UIDropDownMenu_SetSelectedID(this, DCT_Get("DCT_FRAME_CONFIG")[DCT_Opani_CurFrameID].fEff)
	UIDropDownMenu_SetWidth(this,180)
	dwGetglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPEX_FONTEFFDDC)
end
function DCT_Opani_FontEffDDC_OnClick()
	local thisID = this:GetID()
...
function DCT_Opani_AnchorDDC_OnShow()
	UIDropDownMenu_Initialize(this, DCT_Opani_AnchorDDC_Initialize)
	if DCT_Get("DCT_FRAME_CONFIG")[DCT_Opani_CurFrameID].anchor then
		UIDropDownMenu_SetSelectedID(this, DCT_Get("DCT_FRAME_CONFIG")[DCT_Opani_CurFrameID].anchor)
	else
		UIDropDownMenu_SetSelectedID(this, 1)
	end
	UIDropDownMenu_SetWidth(this,60)
	dwGetglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPANI_ANCHORDDC)
end
function DCT_Opani_AnchorDDC_OnClick()
	local thisID = this:GetID()
...
function DCT_Opani_AniTypeDDC_OnShow()
	UIDropDownMenu_Initialize(this, DCT_Opani_AniTypeDDC_Initialize)
	UIDropDownMenu_SetSelectedID(this, DCT_Get("DCT_FRAME_CONFIG")[DCT_Opani_CurFrameID].aniType)
	UIDropDownMenu_SetWidth(this,80)
	dwGetglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPANI_ANITYPEDDC)
end
function DCT_Opani_AniTypeDDC_OnClick()
	local thisID = this:GetID()
...
function DCT_Opani_param1DDC_OnShow()
	...
	UIDropDownMenu_Initialize(this, DCT_Opani_param1DDC_Initialize)	
	UIDropDownMenu_SetSelectedID(this, DCT_Get("DCT_FRAME_CONFIG")[DCT_Opani_CurFrameID][ddcp.param])
	UIDropDownMenu_SetWidth(this,120)
	dwGetglobal(this:GetName().."Label"):SetText(ddcp.name)
end
function DCT_Opani_param1DDC_OnClick()
	local thisID = this:GetID()
...
function DCT_Opani_param2DDC_OnShow()
	...
	UIDropDownMenu_Initialize(this, DCT_Opani_param2DDC_Initialize)	
	UIDropDownMenu_SetSelectedID(this, DCT_Get("DCT_FRAME_CONFIG")[DCT_Opani_CurFrameID][ddcp.param])
	UIDropDownMenu_SetWidth(this,120)
	dwGetglobal(this:GetName().."Label"):SetText(ddcp.name)
end
function DCT_Opani_param2DDC_OnClick()
	local thisID = this:GetID()
...
function DCTFrameBoxMouseDown(button)	
	local c = string.len(this:GetName())
	local fId = tonumber(string.sub(this:GetName(),21,c))
