...
function DCT_Opani_FrameDDC_OnShow()
	...
	getglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPANI_FRAMEDDC)
end
...
function DCT_Opani_FontEnDDC_OnShow()
	...
	getglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPEX_FONTENDDC)
end
...
function DCT_Opani_FontChDDC_OnShow()
	...
	UIDropDownMenu_SetWidth(this,180)
	getglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPEX_FONTCHDDC)
end
...
function DCT_Opani_FontEffDDC_OnShow()
	...
	UIDropDownMenu_SetWidth(this,180)
	getglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPEX_FONTEFFDDC)
end
...
function DCT_Opani_AnchorDDC_OnShow()
	...
	getglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPANI_ANCHORDDC)
end
...
function DCT_Opani_AniTypeDDC_OnShow()
	...
	getglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPANI_ANITYPEDDC)
end
...
function DCT_Opani_param1DDC_OnShow()
	...
	UIDropDownMenu_SetWidth(this,120)
	getglobal(this:GetName().."Label"):SetText(ddcp.name)
end
