...
function DCT_Opspec_SpecBuffListDDC_OnShow()
	local k,v
	local i = 1
	local specbuffP = DCT_Get("DCT_SPECBUFF")
	UIDropDownMenu_Initialize(this, DCT_Opspec_SpecBuffListDDC_Initialize)
	...
	dwGetglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPSPEC_BUFFLISTDDC)
end

function DCT_Opspec_SpecBuffListDDC_OnClick()
...
function DCT_Opspec_BuffFadeListDDC_OnShow()
	local k,v
	local i = 1
	local specbuffP = DCT_Get("DCT_SPECBUFFFADE")
	UIDropDownMenu_Initialize(this, DCT_Opspec_BuffFadeListDDC_Initialize)
	UIDropDownMenu_SetSelectedID(this, 1)
	UIDropDownMenu_SetWidth(this,120)
	for k,v in pairs(specbuffP) do
		if i == 1 then
...
function DCT_Opspec_BuffFadeListDDC_OnClick()
	local thisID = this:GetID()	
...
function DCT_Opspec_SpellSuccessListDDC_OnShow()
	local k,v
	local i = 1
	local specbuffP = DCT_Get("DCT_SPECSPELLSUCCESS")
	UIDropDownMenu_Initialize(this, DCT_Opspec_SpellSuccessListDDC_Initialize)
	UIDropDownMenu_SetSelectedID(this, 1)
	UIDropDownMenu_SetWidth(this,120)
	for k,v in pairs(specbuffP) do
		if i == 1 then
	...
	dwGetglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPSPEC_SPELLLISTDDC)
end

function DCT_Opspec_SpellSuccessListDDC_OnClick()
	local thisID = this:GetID()	
...
function DCT_Opspec_SpellFailedListDDC_OnShow()
	local k,v
	local i = 1
	local specbuffP = DCT_Get("DCT_SPECSPELLFAILED")
	UIDropDownMenu_Initialize(this, DCT_Opspec_SpellFailedListDDC_Initialize)
	UIDropDownMenu_SetSelectedID(this, 1)
	UIDropDownMenu_SetWidth(this,120)
	for k,v in pairs(specbuffP) do
		if i == 1 then
...
function DCT_Opspec_SpellFailedListDDC_OnClick()
	local thisID = this:GetID()	
...
function DCT_Opspec_CoolDownListDDC_OnShow()
	local k,v
	local i = 1
	local specbuffP = DCT_Get("DCT_SPECCOOLDOWN")
	UIDropDownMenu_Initialize(this, DCT_Opspec_CoolDownListDDC_Initialize)
	UIDropDownMenu_SetSelectedID(this, 1)
	UIDropDownMenu_SetWidth(this,120)
	for k,v in pairs(specbuffP) do
		if i == 1 then
...
function DCT_Opspec_CoolDownListDDC_OnClick()
	local thisID = this:GetID()	
