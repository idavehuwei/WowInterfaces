...
DCT_PRESET_TEXT = {
	[1] = {
		...
		["DCT_SHOWCP"] = {show = {"#am 連擊點","#c1**#ce終結技#c1**#ce"}},
		["DCT_SHOWBUFF"] = {show = {"獲得: #sn"}},
		["DCT_SHOWDEBUFF"] = {show = {"減益效果: #sn"}},
		["DCT_SHOWBUFFFADE"] = {show = {"消失: #sn","#sn"}},
		["DCT_SHOWDEBUFFFADE"] = {show = {"消失:#c1#sn#ce"}},
		["DCT_SHOWBUFFDOSE"] = {show = {"堆疊: #sn<#am>","減少: #sn<#am>"}},
		["DCT_SHOWDEBUFFDOSE"] = {show = {"減益堆疊: #sn<#am>","減益減少: #sn<#am>"}},
	...
	[2] = {
		...
		["DCT_SHOWDEBUFF"] = {show = {"#ic減益效果: #sn"}},
		["DCT_SHOWBUFFFADE"] = {show = {"#ic消失: #sn","#ic#sn"}},
		["DCT_SHOWDEBUFFFADE"] = {show = {"#ic消失:#c1#sn#ce"}},
		["DCT_SHOWBUFFDOSE"] = {show = {"#ic堆疊: #sn<#am>","#ic減少: #sn<#am>"}},
		["DCT_SHOWDEBUFFDOSE"] = {show = {"#ic減益堆疊: #sn<#am>","#ic減益減少: #sn<#am>"}},
	...
	[3] = {
		...
		["DCT_SHOWDEBUFF"] = {show = {"減益效果: #ic#sn"}},
		["DCT_SHOWBUFFFADE"] = {show = {"消失: #ic#sn","#ic#sn"}},
		["DCT_SHOWDEBUFFFADE"] = {show = {"消失:#ic#c1#sn#ce"}},
		["DCT_SHOWBUFFDOSE"] = {show = {"堆疊: #ic#sn<#am>","減少: #ic#sn<#am>"}},
		["DCT_SHOWDEBUFFDOSE"] = {show = {"減益堆疊: #ic#sn<#am>","減益減少: #ic#sn<#am>"}},
	...
	[4] = {
		...
		["DCT_SHOWDEBUFF"] = {show = {"減益效果: #sn#ic"}},
		["DCT_SHOWBUFFFADE"] = {show = {"消失: #sn#ic","#sn#ic"}},
		["DCT_SHOWDEBUFFFADE"] = {show = {"消失:#c1#sn#ce#ic"}},
		["DCT_SHOWBUFFDOSE"] = {show = {"堆疊: #sn<#am>#ic","減少: #sn<#am>#ic"}},
		["DCT_SHOWDEBUFFDOSE"] = {show = {"減益堆疊: #sn<#am>#ic","減益減少: #sn<#am>#ic"}},
