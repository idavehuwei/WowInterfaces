...
function DCT_Opspec_TargetBuffListDDC_OnShow()
	local k,v
	local i = 1
	local specbuffP = DCT_Get("DCT_SPECTARGETBUFF")
	UIDropDownMenu_Initialize(this, DCT_Opspec_TargetBuffListDDC_Initialize)
...
function DCT_Opspec_TargetBuffListDDC_OnClick()
...
function DCT_Opspec_TargetBuffFadeListDDC_OnShow()
	local k,v
	local i = 1
	local specbuffP = DCT_Get("DCT_SPECTARGETBUFFFADE")
	UIDropDownMenu_Initialize(this, DCT_Opspec_TargetBuffFadeListDDC_Initialize)
	UIDropDownMenu_SetSelectedID(this, 1)
	UIDropDownMenu_SetWidth(this,120)
	for k,v in pairs(specbuffP) do
		if i == 1 then
