...
function DCT_Opsave_SaveListDDC_OnShow()
	...
	getglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPSAVE_SAVELISTDDC)
end
...
function DCT_Opsave_PreSetAniListDDC_OnShow()
	...
	UIDropDownMenu_SetWidth(this,180)
	getglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPSAVE_PRESETANILISTDDC)
end
...
function DCT_Opsave_PreSetTextListDDC_OnShow()
	...
	UIDropDownMenu_SetSelectedID(this, sel)
	UIDropDownMenu_SetWidth(this,180)
	getglobal(this:GetName().."Label"):SetText(DCT_TEXT_OPSAVE_PRESETTEXTLISTDDC)
end
