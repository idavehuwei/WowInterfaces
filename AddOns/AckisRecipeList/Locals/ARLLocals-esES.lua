...
L["Scan Professions"] = "Explorar Profesiones"
...
L["Scan Spell ID"] = "Explorar Hechizo ID"
...
L["Zurai"] = true
L["ToC/Description"] = "Muestra una lista de recetas inexistentes para sus Habilidades de Comercio. Funciona con todas las habilidades comerciales, incluidas venenos y entrenamiento de bestias del cazador."
