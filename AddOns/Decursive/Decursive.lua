...
function D:BetaWarning()
    ...
    if (("2.4.2_beta_6-12-g708f71e"):lower()):find("beta") or alpha then

    -- if self.profile.NonRealease ~= "2.4.2_beta_6-12-g708f71e" then
    --     self.profile.NonRealease = "2.4.2_beta_6-12-g708f71e";
    --     StaticPopup_Show ("Decursive_Notice_Frame", "|cff00ff00Decursive version: 2.4.2_beta_6-12-g708f71e|r\n\n" .. "|cFFFFAA66" .. L["DEV_VERSION_ALERT"] .. "|r");
    -- end
...
DcrLoadedFiles["Decursive.lua"] = "2.4.2_beta_6-12-g708f71e";
