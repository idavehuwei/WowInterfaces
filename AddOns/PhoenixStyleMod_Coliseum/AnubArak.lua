...
out("|cff99ffff"..psPhoenixStyle.."|r - |cffff0000"..psattention.."|r '|CFF00FF00"..psanubheal[i].."|r' - "..psnotfoundinr)
end
	end
end
		else out("|cff99ffff"..psPhoenixStyle.."|r - |cffff0000"..pserror.."|r "..psnopermissmark)
		end
end
